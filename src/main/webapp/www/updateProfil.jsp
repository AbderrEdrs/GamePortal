...
<html>
    ...
    <body>
        <div class="container">
            <form method="POST" action="/UpdateProfilServelt" enctype="multipart/form-data" class="form-signin">

                <h3>Modification Informations personnelles</h3>
                    
                <div class="${ style }">${ message }</div>

                <label for="username">Pseudo <span class="requis">*</span></label>
                <input type="text" id="username" name="username" value="${ user.username }"  class="input-block-level" required/>
                <br />
                ...
                <input type="email" id="email" name="email" value="${ user.email }" class="input-block-level" required/>
                <br />
